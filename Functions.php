...
function web_invoice_currency_allowed_array() {
	...
	$allowed_currencies_array = array();
	foreach ($allowed_currencies as $allowed_currency) {
		$allowed_currencies_array[$allowed_currency] = web_invoice_currency_symbol($allowed_currency);
	}
	return $allowed_currencies_array;
}
...
function web_invoice_currency_array() {
	$currency_list = array(
		...
		"LKR"=> __("Sri Lankan Rupee", WEB_INVOICE_TRANS_DOMAIN),
		"INR"=> __("Indian Rupee", WEB_INVOICE_TRANS_DOMAIN),
	);
...
function web_invoice_currency_symbol_format($currency = "USD" )
{
	$currency_list = array(
		...
		'LKR' => __('Rs. %s', WEB_INVOICE_TRANS_DOMAIN),
		'INR' => __('Rs. %s', WEB_INVOICE_TRANS_DOMAIN),
	);
...
function web_invoice_process_settings() {
	...
	if(isset($_POST['web_invoice_allowed_currencies'])) {
		update_option('web_invoice_allowed_currencies_set', $_POST['web_invoice_allowed_currencies_set']);
