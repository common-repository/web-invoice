...
<p><?php printf(__('You need a %4$s account with Merchant status, %7$s Business account, %5$s account, %6$s account or a credit card processing account to use recurring billing. You may get an ARB (Automated Recurring Billing) account from %1$s (800-546-1997), %2$s (888-845-9457) or %3$s (866-400-9706).', WEB_INVOICE_TRANS_DOMAIN), 
		...
		'<a href="https://www.paypal.com/us/mrb/pal=TW8P6LGF47FM4">PayPal Payflow Pro</a>'); ?></p>
...
<div id="poststuff" class="metabox-holder">
	<form id="new_web_invoice_form" action="admin.php?page=new_web_invoice&amp;web_invoice_action=save_and_preview" method="POST">
		...
		<div class="postbox" >
			...
			<div class="web_invoice_enable_recurring_billing inside"
			<?php if(!$web_invoice_recurring_billing) { ?> style="display: none;"
			<?php } ?>>
		...
		<div id="web_invoice_main_info" class="postbox">
						...
						<table id="invoice_list" class="itemized_list">
							...
							<tr valign="top">
								...
								<td valign="top" class="name"><input class="item_name"
									...
									value="<?php echo isset($itemized_item['name'])?stripslashes($itemized_item['name']):''; ?>" /></td>
								<td valign="top" class="description"><textarea style="height: 25px;"
									name="itemized_list[<?php echo $counter; ?>][description]"
									class="item_description autogrow"><?php echo isset($itemized_item['description'])?stripslashes($itemized_item['description']):''; ?></textarea></td>
								<td valign="top" class="quantity"><input
									value="<?php echo isset($itemized_item['quantity'])?stripslashes($itemized_item['quantity']):''; ?>"
								...
								<td valign="top" class="price"><input
									value="<?php echo isset($itemized_item['price'])?stripslashes($itemized_item['price']):''; ?>"
...
<div id="web_invoice_templates_tab_pane" class="web_invoice_tab_pane">
	...
	style="float: right; width: 187px; height: 220px; margin-top: 35px; margin-right: 5px;"></iframe>
<div id="web_invoice_templates_tab_email">
<table class="form-table settings_page_table web_invoice_settings_table" style="clear: left;">
	<tr>
...
<div id="web_invoice_settings_tab_pane" class="web_invoice_tab_pane">
	...
	<iframe
	src="https://secure.mohanjith.com/wp/web-invoice.php"
	style="float: right; width: 187px; height: 220px; z-index: 100; margin-top: 35px; margin-right: 5px;"></iframe>
...
<table class="form-table settings_page_table web_invoice_settings_table" style="clear: left;">
	...
	<tr>
		...
		<td><?php echo web_invoice_draw_select(
			'web_invoice_default_currency_code',
...
<table class="form-table settings_page_table web_invoice_settings_table" style="clear: left;">
	...
	<tr class="alertpay_info">
		...
		<a id="web_invoice_alertpay_register_link" href="https://www.payza.com/"
			class="web_invoice_click_me"><?php _e("Do you need an Payza account?", WEB_INVOICE_TRANS_DOMAIN) ?></a>
		</td>
	</tr>
	<tr class="alertpay_info">
	...
	<tr class="tco_info 2co_info">
		...
		<a id="web_invoice_2co_register_link" href="https://www.2checkout.com/"
	...
	<tr class="moneybookers_info">
		...
		<a id="web_invoice_moneybookers_register_link"
			href="https://www.skrill.com/en/payment-solutions/"
	...
	<tr class="google_checkout_info">
		...
		<a id="web_invoice_google_checkout_register_link" href="https://wallet.google.com/merchant/signup"
	...
	<tr class="paypal_info">
		...
		<td><input id='web_invoice_paypal_address'
			...
			<a id="web_invoice_paypal_register_link" href="https://www.paypal.com/webapps/mpp/merchant"
	...
	<tr class="payflow_info">
		...
		<td><input id='web_invoice_payflow_login'
			...
			<a id="web_invoice_payflow_register_link" href="https://www.paypal.com/webapps/mpp/payflow-payment-gateway"
				class="web_invoice_click_me"><?php _e("Do you need a PayPal account?", WEB_INVOICE_TRANS_DOMAIN) ?></a>
		</td>
	</tr>
	<tr class="payflow_info">
	...
	<tr class="pfp_info">
		...
		<td><input id='web_invoice_pfp_partner'
			...
			<a id="web_invoice_pfp_register_link" href="https://www.paypal.com/webapps/mpp/payflow-payment-gateway"
				class="web_invoice_click_me"><?php _e("Do you need a PayPal account?", WEB_INVOICE_TRANS_DOMAIN) ?></a>
		</td>
	</tr>
	<tr class="pfp_info">
	...
	<tr class="sagepay_info">
		...
		<a id="web_invoice_sagepay_register_link" href="http://www.sagepay.co.uk/"
